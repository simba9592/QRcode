                    ...
                    <Card>
                        <CardBody>
                            <div className="text-muted">
                                ...
                                <div>
                                    <button type="button" className="btn btn-link link-success p-0 shadow-none">Read more</button>
                                </div>
...
{/* 
                            <SimpleBar style={{ height: "300px" }} className="px-3 mx-n3 mb-2">
                                <div className="d-flex mb-4">
                                    <div className="flex-shrink-0">
                                        <img src={avatar8} alt="" className="avatar-xs rounded-circle shadow" />
                                    </div>
                                    <div className="flex-grow-1 ms-3">
                                        ...
                                        <div className="d-flex mt-4">
                                            <div className="flex-shrink-0">
                                                <img src={avatar10} alt="" className="avatar-xs rounded-circle shadow" />
                                            </div>
                                            <div className="flex-grow-1 ms-3">
                                ...
                                <div className="d-flex mb-4">
                                    <div className="flex-shrink-0">
                                        <img src={avatar6} alt="" className="avatar-xs rounded-circle shadow" />
                                    </div>
                                    <div className="flex-grow-1 ms-3">
                ...
                <Col xl={3} lg={4}>
                                ...
                                <div className="vstack gap-3">
                                    <div className="d-flex align-items-center">
                                        <div className="avatar-xs flex-shrink-0 me-3">
                                            <img src={avatar2} alt="" className="img-fluid rounded-circle shadow" />
                                        </div>
                                    ...
                                    <div className="d-flex align-items-center">
                                        <div className="avatar-xs flex-shrink-0 me-3">
                                            <div className="avatar-title bg-soft-danger text-danger rounded-circle shadow">
                                                HB
                                            </div>
                                        </div>
                                        <div className="flex-grow-1">
                                    ...
                                    <div className="d-flex align-items-center">
                                        <div className="avatar-xs flex-shrink-0 me-3">
                                            <img src={avatar3} alt="" className="img-fluid rounded-circle shadow" />
                                        </div>
                                        <div className="flex-grow-1">
                                    ...
                                    <div className="d-flex align-items-center">
                                        <div className="avatar-xs flex-shrink-0 me-3">
                                            <img src={avatar4} alt="" className="img-fluid rounded-circle shadow" />
                                        </div>
                                        <div className="flex-grow-1">
                                    ...
                                    <div className="d-flex align-items-center">
                                        <div className="avatar-xs flex-shrink-0 me-3">
                                            <img src={avatar7} alt="" className="img-fluid rounded-circle shadow" />
                                        </div>
                                        <div className="flex-grow-1">
                    ...
                    <Card>
                        <CardHeader className="align-items-center d-flex border-bottom-dashed">
                            ...
                            <div className="flex-shrink-0">
                                <button type="button" className="btn btn-soft-info btn-sm shadow-none"><i className="ri-upload-2-fill me-1 align-bottom"></i> Upload</button>
                            </div>
                        </CardHeader>

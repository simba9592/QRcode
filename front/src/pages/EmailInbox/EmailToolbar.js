                ...
                <div className="p-4 d-flex flex-column h-100">
                    ...
                    >
                        ...
                        <div className="border-top border-top-dashed pt-3 mt-3">
                            ...
                            <div className="mt-2 vstack gap-3 email-chat-list">

                                {chatData.map((item, key) => (<Link to="#" className="d-flex align-items-center" key={key}>
                                    <div className="flex-shrink-0 me-2 avatar-xs chatlist-user-image">
                                        <img
                    ...
                    <div className="border-bottom border-bottom-dashed">
                        <Row className="mt-n2 mb-3 mb-sm-0">
                            <Col className="col-sm-auto order-1 d-block d-lg-none">
                                <button type="button" className="btn btn-soft-success btn-icon btn-sm fs-16 email-menu-btn shadow-none">
                                ...
                                <div className="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                                    ...
                                    <div id="email-topbar-actions" style={{ display: "none" }}>
                                        <div className="hstack gap-sm-1 align-items-center flex-wrap">
                                            <button type="button" className="btn btn-ghost-secondary btn-icon btn-sm fs-16 shadow-none" id="Tooltip1">
                                                <i className="ri-inbox-archive-fill align-bottom"></i>
                                            </button>
                                            <button type="button" className="btn btn-ghost-secondary btn-icon btn-sm fs-16 shadow-none" id="Tooltip2">
                                                <i className="ri-error-warning-fill align-bottom"></i>
                                            </button>
                                            <button type="button" className="btn btn-ghost-secondary btn-icon btn-sm fs-16 shadow-none" id="Tooltip3" onClick={() => { setDeleteModal(true); }} >
                                ...
                                mailList.filter(({ category, type, label }) => displayCategory === category || (displayCategory === "all" && (displaytype === type || displaytype === 'all') && (displaylabel === label || displaylabel === 'all'))).map((item, key) => (
                                    <li className={item.unread ? "unread" : null} key={key} id={item.forId}>
                                        <div className="col-mail col-mail-1">
                                            ...
                                            <button type="button" className="btn avatar-xs p-0 favourite-btn fs-15 shadow-none" onClick={(e) => favouriteBtn(e.target)}>
                ...
                <div className="p-4 d-flex flex-column h-100">
                    <div className="pb-4 border-bottom border-bottom-dashed">
                        <Row>
                            <Col className="col">
                                <div className="">
                                    <button type="button" className="btn btn-soft-danger btn-icon btn-sm fs-16 close-btn-email shadow-none" onClick={() => sidebarClose("email-detail-show")}>
                            ...
                            <Col className="col-auto">
                                <div className="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                                    <button type="button" className="btn btn-ghost-secondary btn-icon btn-sm fs-16 favourite-btn shadow-none active">
                                        <Rating
                                            stop={1}
                                    ...
                                    <button className="btn btn-ghost-secondary btn-icon btn-sm fs-16 shadow-none">
                                ...
                                <div className="accordion-header">
                                    <a href='/#' role="button" className="btn w-100 text-start px-0 bg-transparent shadow-none collapsed"
                                        ...
                                        <div className="d-flex align-items-center text-muted">
                                            ...
                                            <div className="flex-grow-1 overflow-hidden">
                                                <h5 className="fs-14 text-truncate email-user-name-right mb-0">Marc Jose Nachar</h5>
                ...
                <Card className="mb-0">
                    <CardHeader className="align-items-center d-flex bg-primary text-white-50">
                        <div className="flex-grow-1">
                            <h5 className="fs-13 text-white mb-1 profile-username">{info.name}</h5>
                    ...
                    <CardBody className="p-0">
                        <div id="users-chat">
                            <SimpleBar className="chat-conversation p-3" id="chat-conversation" style={{ height: "250px" }}>

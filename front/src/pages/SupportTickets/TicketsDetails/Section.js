...
import img from "../../../assets/images/companies/download.jfif";
                            ...
                            <Row>
                                <div className="col-md">
                                    <Row className="align-items-center">
                                        ...
                                        <div className="col-md">
                                            <h4 className="fw-semibold">#01-001 - Cessna 210</h4>
                                            <div className="hstack gap-3 flex-wrap">
                                                <div className="text-muted"><i className="ri-building-line align-bottom me-1"></i> Themesbrand</div>
                                                <div className="vr"></div>
                                                <div className="text-muted">Create Date : <span className="fw-medium">20 Dec, 2021</span></div>
                                                <div className="vr"></div>
                                                <div className="text-muted">Due Date : <span className="fw-medium">29 Dec, 2021</span></div>
                                                <div className="vr"></div>
                                ...
                                <div className="col-md-auto mt-md-0 mt-4">
                                    <div className="hstack gap-1 flex-wrap">
                                        <button type="button" className="btn avatar-xs mt-n1 p-0 favourite-btn shadow-none active">

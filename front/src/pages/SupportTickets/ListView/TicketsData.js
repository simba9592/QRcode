...
const TicketsData = () => {
    ...
    const validation = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            assigned: Yup.string().required("Please Enter Pilot Name"),
        ...
        <React.Fragment>
                    ...
                    <Card>
                        <CardHeader className="border-0">
                            <div className="d-flex align-items-center">
                                <h5 className="card-title mb-0 flex-grow-1">Airplane</h5>
                                <div className="flex-shrink-0">
                                    <button className="btn btn-danger add-btn" onClick={() => { setIsEdit(false); toggle(); }}><i className="ri-add-line align-bottom"></i> Register Airplane</button>
                                </div>
                            </div>
                        </CardHeader>
                                ...
                                <Row className="g-3">
                                    <Col xxl={5} sm={12}>
                                        <div className="search-box">
                                            <Input type="text" className="form-control search bg-light border-light" placeholder="Search for Airplane details or something..." />
            ...
            >
                ...
                <ModalHeader toggle={toggle} className="p-3 bg-soft-info">
                    {!!isEdit ? "Edit Ticket" : "Add Airplane"}
                </ModalHeader>
                <Form onSubmit={(e) => {
                    e.preventDefault();
                    ...
                    <ModalBody>
                        <Row className="g-3">
                            ...
                            <Col lg={6}>
                                <div>
                                    <Label htmlFor="client_nameName-field" className="form-label">Cpmpany</Label>
                                    <Input
                                        name="client"
                                        type="text"
                            ...
                            <Col lg={6}>
                                <div>
                                    <Label htmlFor="assignedtoName-field" className="form-label">Pilot</Label>
                                    <Input
                                        name="assigned"
                                        type="text"
                            ...
                            <Col lg={6}>
                                <Label htmlFor="priority-field" className="form-label">Payment</Label>
                                <Input
                                    name="priority"
                                    type="select"
                                    className="form-select"
                                ...
                                >
                                    ...
                                    <option value="High">Unpaid</option>
                                    <option value="Medium">Inprogress</option>
                                    <option value="Low">Paid</option>
                                </Input>
                    ...
                    <div className="modal-footer">
                        <div className="hstack gap-2 justify-content-end">
                            ...
                            <button type="submit" className="btn btn-success" id="add-btn">{!!isEdit ? "Update" : "Add Airplane"}</button>
                        </div>
                    </div>
                </Form>
            </Modal>

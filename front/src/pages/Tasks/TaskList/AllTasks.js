...
const Assigned = [
  { id: 1, imgId: "anna-adame", img: avatar1, name: "Marc Jose Nachar" },
...
const AllTasks = () => {
  ...
  const [modal_addpilot, setmodal_addPilot] = useState(false);
  function addPilot() {
    setmodal_addPilot(!modal_addpilot);
  }
  ...
  return (
    <React.Fragment>
        ...
        <div className="card" id="tasksList">
          <div className="card-header border-0">
            <div className="d-flex align-items-center">
              <h5 className="card-title mb-0 flex-grow-1">Pilot List</h5>
              <Button color="secondary" size="sm" className="btn-soft-secondary shadow-none me-1" onClick={() => addPilot()}>
                Add Pilot
              </Button>
              ...
              <div className="row g-3">
                {/* <div className="col-xxl-5 col-sm-12">
                    <div className="search-box">
                      <input type="text" className="form-control search bg-light border-light" placeholder="Search for Pilot or something..." />
      ...
      >
        ...
        <Form onSubmit={(e) => {
          ...
          <ModalBody className="modal-body">
            <Row className="g-3">
              <Col lg={12}>
                <Label for="taskId-field" className="form-label">Pilot Name</Label>
                <Input
                  name="taskId"
                  id="taskId-field"
      ...
      <Modal id="top-rightmodal" isOpen={modal_addpilot} toggle={() => { addPilot(); }} className="modal-dialog-right" >
        <ModalHeader>
          Select Management
          <Button type="button" className="btn-close" onClick={() => { setmodal_addPilot(false); }} aria-label="Close"> </Button>
        </ModalHeader>
        <ModalBody>
          <div>
            <div className="mb-3">
          ...
          <div className="col-auto">
                <button type="button" className="btn btn-soft-success shadow-none"> submit</button>
              </div>
        </ModalBody>
      </Modal>
    </React.Fragment>

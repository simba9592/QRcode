                ...
                <Container fluid>
                    ...
                    <div className="pt-4 mb-4 mb-lg-3 pb-lg-4">
                        <Row className="g-4">
                            ...
                            <Col>
                                <div className="p-2">
                                    <h3 className="text-white mb-1">Marc Jose Nachar</h3>
                                    <p className="text-white-75">Pilot</p>
                                                        ...
                                                        <div className="d-flex flex-wrap gap-2">
                                                            <div>
                                                                <Link to="#" className="avatar-xs d-block">
                                                                    <span
                                                                        className="avatar-title rounded-circle fs-16 bg-dark text-light shadow">
                                                            ...
                                                            <div>
                                                                <Link to="#" className="avatar-xs d-block">
                                                                    <span
                                                                        className="avatar-title rounded-circle fs-16 bg-primary shadow">
                                                            ...
                                                            <div>
                                                                <Link to="#" className="avatar-xs d-block">
                                                                    <span
                                                                        className="avatar-title rounded-circle fs-16 bg-success shadow">
                                                            ...
                                                            <div>
                                                                <Link to="#" className="avatar-xs d-block">
                                                                    <span
                                                                        className="avatar-title rounded-circle fs-16 bg-danger shadow">
                                                        ...
                                                        <div className="d-flex mb-4">
                                                            <div className="flex-shrink-0">
                                                                <img src={smallImage4} alt=""
                                                                    height="50" className="rounded shadow" />
                                                            </div>
                                                            ...
                                                            <Col xs={6} md={4}>
                                                                <div className="d-flex mt-4">
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            className="avatar-title bg-light rounded-circle fs-16 text-primary shadow">
                                                                                        ...
                                                                                        <Link className="accordion-button p-2 shadow-none"
                                                                                            ...
                                                                                            <div className="d-flex">
                                                                                                <div className="avatar-xs">
                                                                                                    <div
                                                                                                        className="avatar-title rounded-circle bg-light text-danger shadow">
                                                                                                        <i
                                                                                            ...
                                                                                            <Row className="mt-2">
                                                                                                <Col xxl={6}>
                                                                                                    <Row
                                                                                                        ...
                                                                                                        <Col xs={3}>
                                                                                                            <img src={smallImage3} alt="" className="img-fluid rounded shadow" />
                                                                                                        </Col>

                                                                                                        <Col xs={3}>
                                                                                                            <img src={smallImage5} alt="" className="img-fluid rounded shadow" />
                                                                                                        </Col>

                                                                                                        <Col xs={3}>
                                                                                                            <img src={smallImage7} alt="" className="img-fluid rounded shadow" />
                                                                                                        </Col>

                                                                                                        <Col xs={3}>
                                                                                                            <img src={smallImage9} alt="" className="img-fluid rounded shadow" />
                                                                                                        </Col>
                                                                                    ...
                                                                                    <div className="accordion-header"
                                                                                        ...
                                                                                        <Link to="#" className="accordion-button p-2 shadow-none" id="collapse10">
                                                                                            <div className="d-flex">
                                                                                                <div
                                                                                                    className="flex-shrink-0">
                                                                                                    <img src={avatar5} alt="" className="avatar-xs rounded-circle shadow" />
                                                                                                </div>
                                                                                                <div
                                                                                                    className="flex-grow-1 ms-3">
                                                                                                    <h6
                                            ...
                                            <CardBody>
                                                ...
                                                <div className="acitivity-timeline">
                                                    <div className="acitivity-item d-flex">
                                                        <div className="flex-shrink-0">
                                                            <img src={avatar1} alt="" className="avatar-xs rounded-circle acitivity-avatar shadow" />
                                                        </div>
                                                    ...
                                                    <div className="acitivity-item py-3 d-flex">
                                                        <div className="flex-shrink-0 avatar-xs acitivity-avatar rounded-circle shadow">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            ...
                                                            <div className="avatar-group mb-2">
                                                                <Link to="#" className="avatar-group-item shadow"
                                                    ...
                                                    <div className="acitivity-item py-3 d-flex">
                                                        <div className="flex-shrink-0">
                                                            <img src={avatar6} alt="" className="avatar-xs rounded-circle acitivity-avatar shadow" />
                                                        </div>
                                                        <div className="flex-grow-1 ms-3">
                                                    ...
                                                    <div className="acitivity-item py-3 d-flex">
                                                        <div className="flex-shrink-0">
                                                            <div className="avatar-xs acitivity-avatar rounded-circle shadow">
                                                                <div
                                                                            ...
                                                                            <div className="d-flex align-items-center gap-2">
                                                                                ...
                                                                                <div className="avatar-group">
                                                                                    {(item.member || []).map((subitem, key) => (
                                                                                        <div className="avatar-group-item shadow" key={key}>
                                                                                            <div className="avatar-xs">

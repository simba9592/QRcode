...
const Register = () => {
    ...
    useEffect(()=>{
        ...
        setVal(SingleOptions);
        setSelectedSingle(SingleOptions[0]);
    },[]);
    
    const handleSelectSingle = (selectedSingle) => {
    ...
    const validation = useFormik({
        ...
        onSubmit: (values) => {
            ...
            param.role = selectedSingle.value;
    ...
    document.title = "Sign Up Airplane System";
                        ...
                        <Row>
                            <Col lg={12}>
                                <div className="text-center mt-sm-5 mb-4 text-white-50">
                                    ...
                                    <p className="mt-3 fs-15 fw-medium">Sign Up To Our Airplane System</p>
                                </div>
                            </Col>
                        </Row>
                                ...
                                <Card className="mt-4">
                                    ...
                                    <CardBody className="p-4">
                                        <div className="text-center mt-2">
                                            ...
                                            <p className="text-muted">Get your free Airplane System account now</p>
                                        </div>

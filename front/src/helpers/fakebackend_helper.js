...
// Login Method
export const postJwtLogin = (url, data) => {
  return api.create(url, data);};

//userlist
export const postUserList = (url, data) => {

  return api.create(url, data);
};

export const postOwenrList = (url, data) => {

  return api.create(url, data);
};

export const postPilotList = (url, data) => {

  return api.create(url, data);
};

export const postAirplaneList = (url, data) => {

  return api.create(url, data);
};

export const postOwnerProfile = (url, data) => {
  return api.create(url, data);
}

export const postAirplaneProfile = (url, data) => {
  return api.create(url, data);
}

export const postPilotProfile = (url, data) => {
  return api.create(url, data);
}

export const getReceiveData = (url, data) => {
  return api.create(url, data);
}


export const postSendReportData = (url, data) => {
  return api.create(url, data);
}
